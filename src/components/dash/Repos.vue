            ...
            <div class="box box-widget widget-user">
              ...
              <div class="box-footer">
                <div class="row">
                  ...
                  <div class="col-sm-4 border-right">
                    <div class="description-block">
                      <button type="button" class="btn btn-block btn-default btn-lg"><a v-bind:href="repo.html_url">Visit</a></button>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="description-block">
...
export default {
  ...
  data: function () {
    return {
      githubUrl: 'https://api.github.com/search/repositories?q=intelmq&sort=stars',
      response: null,
      error: null
    }
  },
